...
Revision ID: 731605e94dd6
Revises: 
Create Date: 2025-03-19 12:26:30.160944
...
def upgrade() -> None:
    ...
    sa.Column('metric_type', sa.Enum('PRODUCTIVITY', 'QUALITY', 'EFFICIENCY', 'COLLABORATION', 'INNOVATION', 'LEADERSHIP', name='metrictype'), nullable=True),
    ...
    sa.Column('id', sa.Integer(), nullable=False),
    sa.Column('employee_id', sa.Integer(), nullable=True),
    sa.Column('report_type', sa.Enum('DAILY', 'WEEKLY', 'MONTHLY', 'QUARTERLY', 'YEARLY', 'CUSTOM', name='reporttype'), nullable=True),
